...
export const CARD_STATS = {
  ...
  // Ronin non è (ancora) su clashroyale.fandom.com, quindi non è passata
  // dallo script: hp11/dmg11 presi da uno screenshot in-game del livello
  // assoluto 11 reale (697→1779 hp, 131→337 dmg), stessa fonte di verità
  // richiesta per le altre carte. Un secondo screenshot al livello 16 dà
  // 2842 hp / 539 dmg, leggermente sotto quello che statAtLevel proietta da
  // qui (2865/543, ~0.8% in più): la crescita reale non è l'esatto 1.1×/
  // livello che questo file assume ovunque, ma qui non c'è un meccanismo
  // per un valore per-livello diverso dalla formula, quindi resta così —
  // scarto noto, non un bug. Ha anche una "parata" (parry: 200% danno
  // riflesso, 3.5s di ricarica) che non è un numero che scala col livello
  // come gli altri campi: fuori scope qui, stesso motivo delle abilità dei
  // Champion (vedi commento di testa).
  "26000106": {
    "name": "Ronin",
    "type": "troop",
    "hp11": 1779,
